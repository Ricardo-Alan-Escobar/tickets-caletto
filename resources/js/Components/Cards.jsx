    ...
    return (
        <>
            <div className="flex w-full mb-3">
                ...
                <div className="block bg-white w-1/4 h-auto mr-4 p-5 rounded-lg border-2 border-slate-200">
                ...
                <div className="block bg-white w-1/4 h-auto p-5 rounded-lg border-2 border-slate-200">
